...
@Component({
  ...
  standalone: true,
  imports: [HeaderComponent,SidenavComponent,MainComponent,MatTabsModule,ConfiguracaoAnaliseComponent,MateriaPrimaComponent,ParametrosComponent,TipoDeAnaliseComponent],
