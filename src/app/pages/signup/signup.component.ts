...
export class SignupComponent {
  ...
  public signupForm = new FormGroup({
    ...
    confirmpassword: new FormControl('',[Validators.required ,Validators.minLength(6),passwordValidator()])
  })
  ...
  this.#loginService.signup(name,email,password,confirmpassword).subscribe({
      next:() => {
